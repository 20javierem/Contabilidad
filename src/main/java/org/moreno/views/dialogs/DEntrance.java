...
public class DEntrance extends JDialog{
    ...
    private void save(){
        ...
        if (errors.isEmpty()) {
            ...
            if(record.getId()==null){
                ...
                limpiarControles();
                Utilities.sendNotification("ÉXITO","Entrada registrado", TrayIcon.MessageType.INFO);
            }else{
                record.save();
    ...
    private void limpiarControles(){
        ...
        spinnerQuantity.setValue(0.0);
        spinnerPrice.setValue(0.0);
    }
    private void createUIComponents() {
        // TODO: place custom component creation code here
        spinnerPrice = new JSpinner(new SpinnerNumberModel(0.0, 0.0, 100000.0, 1.0));
        spinnerPrice.setEditor(new JSpinner.NumberEditor(spinnerPrice, "S/#,##0.###"));
        spinnerQuantity = new JSpinner(new SpinnerNumberModel(0.0, 0.0, 100000.0, 1.0));
