package org.moreno.utilitiesTables;

import org.moreno.utilities.Utilities;
import org.moreno.utilitiesTables.buttonEditors.JButtonAction;
...
public class UtilitiesTables {
    ...
    public static void pintarComponente(Component component,boolean estado,boolean isSelected){
        if(!estado){
            if(!isSelected){
                component.setBackground(new Color(0xFFEAA9A9, true));
                component.setForeground(new Color(0x2F5597));
            }
        }
    }
}
